...
insert into user (username, password, name, email, mobile, enabled) values ('admin', 'password', 'Administrator', 'admin@ring2park.com', '0887712345678', true)
insert into user (username, password, name, email, mobile, enabled) values ('fred', 'password', 'Fred Flintstone', 'fred@flintstones.com', '07777123123123', true)
insert into user (username, password, name, email, mobile, enabled) values ('barney', 'password', 'Barney Rubble', 'barney@flinstones.com', '0778845645677', false)
